...
module JRubyFX
  module DSL
    NAME_TO_CLASSES = {
      # Manual overrides
      'observable_array_list' => proc { |*args| Java::javafx.collections.FXCollections.observable_array_list(*args) },
      'observable_map' => proc { |*args| Java::javafx.collections.FXCollections.observable_map({}) },
