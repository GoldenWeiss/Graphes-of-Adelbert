...
ENDNAIVE
    ...
    def self.load_dsl
    	require_relative 'core_ext/border_pane.rb'
    	require_relative 'core_ext/column_constraints.rb'
    	require_relative 'core_ext/drag_event.rb'
    	require_relative 'core_ext/duration.rb'
    	require_relative 'core_ext/effects.rb'
    	require_relative 'core_ext/file_chooser.rb'
    	require_relative 'core_ext/geometry.rb'
    	require_relative 'core_ext/grid_pane.rb'
    	require_relative 'core_ext/image_view.rb'
    	require_relative 'core_ext/media_player.rb'
    	require_relative 'core_ext/observable_value.rb'
    	require_relative 'core_ext/pagination.rb'
    	require_relative 'core_ext/path.rb'
    	require_relative 'core_ext/precompiled.rb'
    	require_relative 'core_ext/progress_indicator.rb'
    	require_relative 'core_ext/radial_gradient.rb'
    	require_relative 'core_ext/region.rb'
    	require_relative 'core_ext/rotate.rb'
    	require_relative 'core_ext/stage.rb'
    	require_relative 'core_ext/table_view.rb'
    	require_relative 'core_ext/timeline.rb'
    	require_relative 'core_ext/transition.rb'
    	require_relative 'core_ext/tree_view.rb'
    	require_relative 'core_ext/xy_chart.rb'
